...
## Usage
```sh
beeper contacts list (contacts ls,contacts search,contacts find,contact list,contact ls,contact search,contact find) [<query>] [flags]
```
## Aliases
...
| Name | Description |
| --- | --- |
| `[<query>]` | Optional contact lookup query. Used when --query is omitted. |
...
| `--limit=50` | Maximum contacts to print Default: `50`. |
| `--query=STRING` | Optional contact lookup query |
