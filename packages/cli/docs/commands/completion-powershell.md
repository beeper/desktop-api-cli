# beeper completion powershell
Generate the autocompletion script for powershell
## Usage
```sh
beeper completion powershell (completion pwsh) [flags]
```
## Aliases

- `beeper completion pwsh`

## Flags

| Name | Description |
| --- | --- |
| `--no-descriptions` | Accepted for compatibility; completion descriptions are not emitted Default: `false`. |
