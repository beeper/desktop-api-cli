# beeper groups create
Create a group chat
## Usage
```sh
beeper groups create (groups add,groups new,group create,group add,group new) [flags]
```
## Aliases
...
| Name | Description |
| --- | --- |
| `--account=STRING` | Account selector |
| `--name=STRING, --title` | Group name Required. |
| `--user=STRING` | Initial participant user ID, phone, or handle Repeatable. Required. |
| `--message=STRING` | Optional first message text |
