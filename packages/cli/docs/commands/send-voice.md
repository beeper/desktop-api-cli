...
## Usage
```sh
beeper send voice [<localPath>] [flags]
```
## Arguments

| Name | Description |
| --- | --- |
| `[<localPath>]` | Local voice note file path to upload. Used when --file is omitted. |
...
| `--file=STRING` | Local voice note file path to upload |
