...
Set or clear a chat description
## Usage
```sh
beeper chats description (chat description) [<chat>] [flags]
```
## Aliases

- `beeper chat description`
...
| `--clear` | Clear or unset the chosen state Default: `false`. |
