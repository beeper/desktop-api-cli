...
## Usage
```sh
beeper chats disappear (chat disappear) [<chat>] [flags]
```
## Aliases

- `beeper chat disappear`
...
| `--seconds=STRING, --duration, --ephemeral-duration` | Disappearing-message timer in seconds, duration form like 24h/7d/90d, or off |
