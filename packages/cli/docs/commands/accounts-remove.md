...
## Usage
```sh
beeper accounts remove (accounts rm,accounts del,remove account,account remove,account rm,account del) <selector> [flags]
```
## Aliases

- `beeper accounts rm`
- `beeper accounts del`
- `beeper remove account`
- `beeper account remove`
- `beeper account rm`
- `beeper account del`
