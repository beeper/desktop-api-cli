...
| `--duration=INTEGER` | Seconds to keep typing before sending paused |
| `--state="typing"` | Presence indicator to send Default: `typing`. Values: `typing`, `paused`. |
