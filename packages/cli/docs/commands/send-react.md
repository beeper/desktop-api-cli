...
| `--id <value>` | Message ID to react to Required. |
| `--reaction <value>` | Reaction key Required. |
| `--remove` | Remove the reaction Default: `false`. |
| `--transaction <value>` | Optional transaction ID for deduplication |
