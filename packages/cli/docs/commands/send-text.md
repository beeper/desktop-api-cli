...
| `--message <value>` | Message text to send |
| `--message-escapes` | Interpret backslash escapes in --message Default: `false`. |
| `--message-file <value>` | Read message text from a file path; '-' reads stdin |
| `--mention <value>` | User ID to mention Repeatable. |
